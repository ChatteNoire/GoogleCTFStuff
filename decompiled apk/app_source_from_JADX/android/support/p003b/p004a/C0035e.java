        ...
        while (true) {
            ...
            if (next != 3 && next != 1) {
                ...
                if (xmlPullParser.getName().equals("keyframe")) {
                    if (i2 == 4) {
                        i2 = C0035e.m54a(resources, theme, Xml.asAttributeSet(xmlPullParser), xmlPullParser);
                    }
                    a = C0035e.m62a(context, resources, theme, Xml.asAttributeSet(xmlPullParser), i2, xmlPullParser);
                    if (a != null) {
                    ...
                    for (i4 = 0; i4 < i3; i4++) {
                        ...
                        if (keyframe.getFraction() >= 0.0f) {
                            if (i4 == 0) {
                                ...
                                C0035e.m70a(keyframeArr, keyframeArr[size + 1].getFraction() - keyframeArr[i4 - 1].getFraction(), i4, size);
                            }
                        }
                    }
