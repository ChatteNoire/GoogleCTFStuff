        ...
        while (i11 < virtualChildCount) {
            ...
            if (b2 == null) {
                ...
                if (mode2 == 1073741824 && c0548a.height == 0 && c0548a.f1801g > 0.0f) {
                    ...
                    int i14 = i3;
                    m2636a(b2, i11, i, 0, i2, f2 == 0.0f ? this.f1815f : 0);
        ...
        if (z && (mode2 == Integer.MIN_VALUE || mode2 == 0)) {
            ...
            while (i4 < virtualChildCount) {
                ...
                if (b == null) {
                    ...
                    int i16 = this.f1815f;
                    this.f1815f = Math.max(i16, (c0548a2.bottomMargin + ((i16 + i10) + c0548a2.topMargin)) + m2637b(b));
                    i3 = i4;
                }
                i4 = i3 + 1;
            }
            ...
            while (i10 < virtualChildCount) {
                ...
                if (b3.getVisibility() == 8) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        f3 -= f6;
                        i15 -= i4;
                        i12 = getChildMeasureSpec(i, ((getPaddingLeft() + getPaddingRight()) + c0548a2.leftMargin) + c0548a2.rightMargin, c0548a2.width);
                    ...
                    obj5 = (obj8 == null || c0548a2.width != -1) ? null : 1;
                    i13 = this.f1815f;
    ...
    void m2641b(int i, int i2) {
        ...
        while (i10 < virtualChildCount) {
            ...
            if (b == null) {
                ...
                i6 = Math.max(i5, i12);
                obj6 = (obj2 == null || c0548a2.height != -1) ? null : 1;
