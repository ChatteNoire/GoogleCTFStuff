    ...
    private void m2649c(int i, int i2) {
        ...
        while (i10 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                c0549c.f1807e = z2;
                int a = m2648a(childAt, i6, c0549c.f1803a ? 1 : i4, childMeasureSpec, paddingTop);
                i8 = Math.max(i8, a);
                paddingLeft = c0549c.f1806d ? i9 + 1 : i9;
            ...
            while (i5 < childCount) {
                ...
                if ((((long) (1 << i5)) & j) != 0) {
                    if (obj3 != null && c0549c.f1807e && i4 == 1) {
                        childAt2.setPadding(this.f1836l + i6, 0, this.f1836l, 0);
                    }
                    c0549c.f1804b++;
                    c0549c.f1808f = true;
                    size = i4 - 1;
        ...
        if (obj3 != null) {
            for (paddingLeft = 0; paddingLeft < childCount; paddingLeft++) {
                ...
                if (c0549c.f1808f) {
                    childAt.measure(MeasureSpec.makeMeasureSpec(c0549c.f1805c + (c0549c.f1804b * i6), 1073741824), childMeasureSpec);
                }
            }
        }
        if (mode == 1073741824) {
